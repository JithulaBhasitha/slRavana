...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Little Hacker' : process.env.OWNER_NAME,
    CP_TEXT: process.env.CP_TEXT === undefined ? '꧁༺ʍǟɖɛ ɮʏ The X ȶɦɛ ɮօȶ༻꧂\n𓂀 𝕝𝕖𝕘𝕖𝕟𝕕 𝕓𝕠𝕥 𝕠𝕗 𝕤𝕣𝕚 𝕝𝕒𝕟𝕜𝕒 𓂀' : process.env.CP_TEXT,
    SONG_UP: process.env.SONG_UP === undefined ? '꧁•٭𝚙𝚕𝚣 𝚠𝚊𝚒𝚝𝚎 The X 𝚋𝚘𝚝 𝚞𝚙𝚕𝚘𝚊𝚍𝚒𝚗𝚐 𝚢𝚘𝚞𝚛 𝚜𝚘𝚗𝚐 𝚚𝚞𝚒𝚌𝚔𝚕𝚢٭•꧂' : process.env.SONG_UP,
    VIDEO_DOWN: process.env.VIDEO_DOWN === undefined ? '(づ｡◕‿‿◕｡)づ The X вσт ∂σωηℓσα∂ιηg уσυя νι∂єσ ٩(˘◡˘)۶' : process.env.VIDEO_DOWN,
    VID_CP: process.env.VID_CP === undefined ? '♣💎  The X 𝔂ŤⒹ𝕃  ♜✌' : process.env.VID_CP,
    VIDEO_UP: process.env.VIDEO_UP === undefined ? '(づ｡◕‿‿◕｡)づ The X вσт υρℓσα∂ιηg уσυя νι∂єσ ٩(˘◡˘)۶' : process.env.VIDEO_UP,
    ...
    BOT: process.env.BOT_NAME === undefined ? '☮ 🇱🇰 The X™' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONG_D: process.env.SONG_D === undefined ? '𝙥𝙡𝙯 𝙬𝙖𝙞𝙩 The X 𝙗𝙤𝙩 𝙨𝙚𝙖𝙧𝙘𝙝𝙞𝙣𝙜 𝙮𝙤𝙪𝙧 𝙨𝙤𝙣𝙜' : process.env.SONG_D,
    ...
    MENUTEXT: process.env.MENUTEXT === undefined ? '𓂀 The X 𝔹𝕠𝕥 𝕄𝕖𝕟𝕦 𓂀' : process.env.MENUTEXT,
    BRANCH: 'main',
    HEROKU: {
